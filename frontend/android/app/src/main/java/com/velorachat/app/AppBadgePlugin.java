...
public class AppBadgePlugin extends Plugin {
    private static final String LOG_TAG = "VeloraBadge";
    ...
    public void setCount(PluginCall call) {
        ...
        try {
            ...
            rejectSafely(call, "Unable to update the launcher badge.", error);
        }
    }
    ...
    public void clear(PluginCall call) {
        try {
            ...
            rejectSafely(call, "Unable to clear the launcher badge.", error);
        }
    }
    ...
    public void isSupported(PluginCall call) {
        try {
            ...
            rejectSafely(call, "Launcher badge support could not be checked.", error);
        }
    }
    ...
    public void testNotification(PluginCall call) {
        try {
            ...
            rejectSafely(call, "Unable to show the badge test notification.", error);
        }
    }
    ...
    private void rejectSafely(PluginCall call, String message, Throwable error) {
