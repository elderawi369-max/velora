...
import { aiCompanionVoiceRoutes } from "./ai-companion-voice";
import { aiCompanionSubscriptionRoutes } from "./ai-companion-subscriptions";
...
apiRoutes.route("/ai-companions", aiCompanionVoiceRoutes);
apiRoutes.route("/ai-companions", aiCompanionSubscriptionRoutes);
