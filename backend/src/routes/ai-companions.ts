...
function createDefaultVisualTraits(companion: typeof aiCompanions.$inferSelect): VisualIdentityTraits {
  ...
  const feminineLooks: Record<(typeof personaKeys)[number], Partial<VisualIdentityTraits>> = {
    supportive_partner: { hair: "chestnut brown, long soft waves", eyes: "warm hazel", skinAppearance: "warm medium complexion", build: "visibly curvy, feminine adult build with a defined waist, fuller natural proportions, and a balanced hourglass silhouette", distinctiveFeatures: ["gentle smile", "subtle freckles"] },
    playful_tease: { hair: "dark espresso brown, playful textured bob", eyes: "bright brown", skinAppearance: "light olive complexion", build: "petite but visibly fit-curvy adult build with a defined waist, fuller natural proportions, and a balanced hourglass silhouette", distinctiveFeatures: ["expressive eyebrows", "small beauty mark near the cheek"] },
    sarcastic_best_friend: { hair: "rich auburn, shoulder-length tousled waves", eyes: "green-brown", skinAppearance: "light warm complexion", build: "lean but visibly curvy adult build with a defined waist, fuller natural proportions, and an hourglass silhouette", distinctiveFeatures: ["knowing half-smile", "faint freckles across the nose"] },
    confident_leader: { hair: "sleek black, long and glossy", eyes: "deep brown", skinAppearance: "golden medium complexion", build: "fit, visibly curvy adult build with a defined waist, fuller natural proportions, and a poised hourglass silhouette", distinctiveFeatures: ["strong brows", "defined cheekbones"] },
    quiet_romantic: { hair: "soft black, long and lightly layered", eyes: "dark brown", skinAppearance: "light warm complexion", build: "soft, visibly curvy adult build with a defined waist, fuller natural proportions, and a graceful hourglass silhouette", distinctiveFeatures: ["gentle eyes", "small beauty mark below one eye"] },
    personal_growth_companion: { hair: "honey blonde, loose shoulder-length waves", eyes: "blue-green", skinAppearance: "light sun-kissed complexion", build: "fit, visibly curvy adult build with a defined waist, fuller natural proportions, and a healthy balanced hourglass silhouette", distinctiveFeatures: ["easy smile", "subtle dimples"] },
  };
...
function canonicalPortraitPrompt(companion: typeof aiCompanions.$inferSelect, traits: VisualIdentityTraits) {
  ...
  const bodyDirection = traits.identity === "woman"
    ? "Show a visibly curvy, fit adult silhouette through the fully clothed outfit: a defined waist, fuller natural chest and hip proportions, and balanced hourglass shape. Do not make her look narrow-framed, boyish, flat, or noticeably thin."
