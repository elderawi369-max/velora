...
function createDefaultVisualTraits(companion: typeof aiCompanions.$inferSelect): VisualIdentityTraits {
  ...
  const feminineLooks: Record<(typeof personaKeys)[number], Partial<VisualIdentityTraits>> = {
    supportive_partner: { hair: "chestnut brown, long soft waves", eyes: "warm hazel", skinAppearance: "warm medium complexion", build: "softly curvy, feminine adult build with a defined waist and a healthy balanced hourglass silhouette", distinctiveFeatures: ["gentle smile", "subtle freckles"] },
    playful_tease: { hair: "dark espresso brown, playful textured bob", eyes: "bright brown", skinAppearance: "light olive complexion", build: "petite fit-curvy adult build with a defined waist and a balanced hourglass silhouette", distinctiveFeatures: ["expressive eyebrows", "small beauty mark near the cheek"] },
    sarcastic_best_friend: { hair: "rich auburn, shoulder-length tousled waves", eyes: "green-brown", skinAppearance: "light warm complexion", build: "lean but clearly curvy adult build with a defined waist and balanced hourglass silhouette", distinctiveFeatures: ["knowing half-smile", "faint freckles across the nose"] },
    confident_leader: { hair: "sleek black, long and glossy", eyes: "deep brown", skinAppearance: "golden medium complexion", build: "fit, curvy adult build with a defined waist and poised hourglass silhouette", distinctiveFeatures: ["strong brows", "defined cheekbones"] },
    quiet_romantic: { hair: "soft black, long and lightly layered", eyes: "dark brown", skinAppearance: "light warm complexion", build: "soft, curvy adult build with a defined waist and graceful hourglass silhouette", distinctiveFeatures: ["gentle eyes", "small beauty mark below one eye"] },
    personal_growth_companion: { hair: "honey blonde, loose shoulder-length waves", eyes: "blue-green", skinAppearance: "light sun-kissed complexion", build: "fit, curvy adult build with a defined waist and healthy balanced hourglass silhouette", distinctiveFeatures: ["easy smile", "subtle dimples"] },
  };
