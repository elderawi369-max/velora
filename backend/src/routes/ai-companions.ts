...
function createDefaultVisualTraits(companion: typeof aiCompanions.$inferSelect): VisualIdentityTraits {
  ...
  const feminineLooks: Record<(typeof personaKeys)[number], Partial<VisualIdentityTraits>> = {
    supportive_partner: { hair: "chestnut brown, long soft waves", eyes: "warm hazel", skinAppearance: "warm medium complexion", build: "curvy hourglass adult figure with a fuller bust, narrow waist, shapely hips and thighs, and toned-but-soft feminine proportions", distinctiveFeatures: ["gentle smile", "subtle freckles"] },
    playful_tease: { hair: "dark espresso brown, playful textured bob", eyes: "bright brown", skinAppearance: "light olive complexion", build: "petite slim-thick adult figure with a fuller bust, narrow waist, shapely hips and thighs, and toned-but-soft feminine proportions", distinctiveFeatures: ["expressive eyebrows", "small beauty mark near the cheek"] },
    sarcastic_best_friend: { hair: "rich auburn, shoulder-length tousled waves", eyes: "green-brown", skinAppearance: "light warm complexion", build: "lean slim-thick adult figure with a fuller bust, narrow waist, shapely hips and thighs, and toned-but-soft feminine proportions", distinctiveFeatures: ["knowing half-smile", "faint freckles across the nose"] },
    confident_leader: { hair: "sleek black, long and glossy", eyes: "deep brown", skinAppearance: "golden medium complexion", build: "curvy hourglass adult figure with a fuller bust, narrow waist, shapely hips and thighs, and polished toned-but-soft feminine proportions", distinctiveFeatures: ["strong brows", "defined cheekbones"] },
    quiet_romantic: { hair: "soft black, long and lightly layered", eyes: "dark brown", skinAppearance: "light warm complexion", build: "soft curvy hourglass adult figure with a fuller bust, narrow waist, shapely hips and thighs, and graceful feminine proportions", distinctiveFeatures: ["gentle eyes", "small beauty mark below one eye"] },
    personal_growth_companion: { hair: "honey blonde, loose shoulder-length waves", eyes: "blue-green", skinAppearance: "light sun-kissed complexion", build: "fit curvy hourglass adult figure with a fuller bust, narrow waist, shapely hips and thighs, and healthy toned-but-soft feminine proportions", distinctiveFeatures: ["easy smile", "subtle dimples"] },
  };
